...
下载Tomcat可以到
[[http://tomcat.apache.org]{.underline}](http://tomcat.apache.org)
下载。
...
![](media/image1.png){width="3.0729166666666665in"
...
![](media/image3.png){width="2.5104166666666665in"
height="1.0520833333333333in"}

检查两个环境变量是否配置成功:

![](media/image4.png){width="3.7916666666666665in" height="1.15625in"}
...
![](media/image5.png){width="4.979166666666667in"
...
![](media/image6.png){width="5.083333333333333in" height="0.40625in"}
...
![](media/image7.png){width="5.770833333333333in" height="1.0625in"}
...
![](media/image8.png){width="3.125in" height="0.6354166666666666in"}
...
![](media/image9.png){width="2.5729166666666665in"
...
![](media/image10.png){width="3.7342038495188103in"
height="1.5106003937007875in"}
...
![](media/image11.png){width="4.640568678915136in"
height="0.7242880577427822in"}

将news配置为缺省的Web应用之后, 访问路径如下:

![](media/image12.png){width="4.656708223972004in"
height="0.7359558180227471in"}

配置缺省的Web应用: 直接将Web应用的目录改成大写的ROOT即可:

![](media/image13.png){width="3.1319827209098863in"
height="1.3627274715660542in"}
...
![](media/image14.png){width="3.2956408573928258in"
height="0.7609930008748906in"}
